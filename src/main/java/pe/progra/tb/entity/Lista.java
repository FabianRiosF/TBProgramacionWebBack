...
public class Lista implements Serializable {
	...
	public Set<Serie> getLista_Serie() {
		return Lista_Serie;
	}


	public void setLista_Serie(Set<Serie> lista_Serie) {
		Lista_Serie = lista_Serie;
	}


	public Set<Pelicula> getLista_Pelicula() {
		return Lista_Pelicula;
	}


	public void setLista_Pelicula(Set<Pelicula> lista_Pelicula) {
		Lista_Pelicula = lista_Pelicula;
	}
	
	
	public Lista(int idLista, String nameLista,Date dateLista, Usuario usuario,Set<Serie> lista_Serie, Set<Pelicula> lista_Pelicula) {
		super();
		this.idLista = idLista;
		this.nameLista = nameLista;
		this.dateLista = dateLista;
